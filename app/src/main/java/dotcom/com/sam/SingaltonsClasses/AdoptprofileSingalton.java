...
public class AdoptprofileSingalton implements Serializable {

    private static final AdoptprofileSingalton ourInstance = new AdoptprofileSingalton();

    public static AdoptprofileSingalton getInstance() {
        return ourInstance;
    }

    private AdoptprofileSingalton() {
    }
