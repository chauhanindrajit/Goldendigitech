...
public class GetPhotograpgySingalton implements Serializable {

    private static final GetPhotograpgySingalton ourInstance = new GetPhotograpgySingalton();

    public static GetPhotograpgySingalton getInstance() {
        return ourInstance;
    }

    private GetPhotograpgySingalton() {
    }
    ...
    public void PhotoResponse(PhotoResponse photoResponse) {
