...
public class DogSingalton implements Serializable {

    private static final DogSingalton ourInstance = new DogSingalton();

    public static DogSingalton getInstance() {
        return ourInstance;
    }

    private DogSingalton() {
    }

    public DogGroomingResponse dogGroomingResponse() {
        return dogGroomingResponse;
    }

    public void DogGroomingResponse(DogGroomingResponse dogGroomingResponse) {
        this.dogGroomingResponse = dogGroomingResponse;
    }

    DogGroomingResponse dogGroomingResponse;
    ...
    private List<DogGroomingResponse.ResponseBean.GroomingdataBean> Groomingdata;
    ...
    public List<DogGroomingResponse.ResponseBean.GroomingdataBean> getGroomingdata() {
        return Groomingdata;
    }

    public void setGroomingdata(List<DogGroomingResponse.ResponseBean.GroomingdataBean> Groomingdata) {
