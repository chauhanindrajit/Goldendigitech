...
public class BuypetprofileSingalton implements Serializable {

    private static final BuypetprofileSingalton ourInstance = new BuypetprofileSingalton();

    public static BuypetprofileSingalton getInstance() {
        return ourInstance;
    }

    private BuypetprofileSingalton() {
    }

    public AdoptpetResponse adoptpetResponse() {
        return adoptpetResponse;
    }

    public void AdoptpetResponse(AdoptpetResponse adoptpetResponse) {
        this.adoptpetResponse = adoptpetResponse;
    }

    AdoptpetResponse adoptpetResponse;
    private int Pet_Id;
