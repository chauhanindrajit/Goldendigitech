...
public class TrainingSingalton implements Serializable {

    private static final TrainingSingalton ourInstance = new TrainingSingalton();

    public static TrainingSingalton getInstance() {
        return ourInstance;
    }

    private TrainingSingalton() {
    }

    public TrainingServicesResponse trainingServicesResponse() {
        return trainingServicesResponse;
    }

    public void TrainingServicesResponse(TrainingServicesResponse trainingServicesResponse) {
        this.trainingServicesResponse = trainingServicesResponse;
    }

    TrainingServicesResponse trainingServicesResponse;
