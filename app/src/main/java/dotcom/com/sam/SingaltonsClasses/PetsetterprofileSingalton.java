...
public class PetsetterprofileSingalton implements Serializable {

    private static final PetsetterprofileSingalton ourInstance = new PetsetterprofileSingalton();

    public static PetsetterprofileSingalton getInstance() {
        return ourInstance;
    }

    private PetsetterprofileSingalton() {
    }
