...
public class VacccinationSingalton implements Serializable {

    private static final VacccinationSingalton ourInstance = new VacccinationSingalton();

    public static VacccinationSingalton getInstance() {
        return ourInstance;
    }

    private VacccinationSingalton() {
    }

    public VaccinationResponse VaccinationResponse() {
        return vaccinationResponse;
    }

    public void VaccinationResponse(VaccinationResponse vaccinationResponse) {
