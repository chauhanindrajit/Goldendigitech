...
public class ProductFilterAdapter extends RecyclerView.Adapter<ProductFilterAdapter.ViewHolderPro> {
    Context context;
    int pos;
    private String[] mValues;
    private static ProductActivity mActivity;
    private List<ProductFilterdataResponse.ResponseBean> details;
