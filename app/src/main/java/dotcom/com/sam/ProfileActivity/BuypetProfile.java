    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enuirynow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SingletonClass.getInstance().setCentername(BuypetprofileSingalton.getInstance().getPet_Name());
                SingletonClass.getInstance().setSRID(String.valueOf(BuypetprofileSingalton.getInstance().getSR_Id()));
                SingletonClass.getInstance().setActivityname("Buy Pet");
                Intent i = new Intent(BuypetProfile.this, ServicesLastPage.class);
                startActivity(i);
            }
        });
